...
parser.add_argument(
    "--output_filelist", required=True, help="TXT filename, filelist, each line is an output for a room"
)
parser.add_argument(
    "--room_data_filelist", required=True, help="TXT filename, filelist, each line is a test room data label file."
)
