...
def insert_batch(data, label, last_batch=False):
    ...
    if last_batch and buffer_size > 0:
        ...
        data_prep_util.save_h5(
            h5_filename, h5_batch_data[0:buffer_size, ...], h5_batch_label[0:buffer_size, ...], data_dtype, label_dtype
        )
...
for i, data_label_filename in enumerate(data_label_files):
    if "Area_5_hallway_6" in data_label_filename:
        print("Skipping {}".format(data_label_filename))
        continue
